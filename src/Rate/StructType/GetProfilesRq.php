...
/**
 * This class stands for GetProfilesRq StructType
 * @subpackage Structs
 */
class GetProfilesRq extends AbstractStructBase
{
    /**
     * The password
    ...
    public $user_id;
    /**
     * Constructor method for GetProfilesRq
     * @uses GetProfilesRq::setPassword()
     * @uses GetProfilesRq::setUser_id()
     ...
     * @param string $password
     * @return \Canpar\Rate\StructType\GetProfilesRq
     */
