...
class ProcessShipmentResult extends AbstractStructBase
{
     ...
     */
    public function __construct(array $errors = array(), array $messages = array(), \Canpar\Rate\StructType\Shipment $shipment = null)
    {
        $this
            ->setErrors($errors)
     ...
     * @param string[] $errors
     * @return \Canpar\Rate\StructType\ProcessShipmentResult
     */
