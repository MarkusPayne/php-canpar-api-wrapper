...
class ProformaItem extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Canpar\Rate\StructType\CommodityInfo
     */
     ...
     * @param \Canpar\Rate\StructType\CommodityInfo $commodity_info
     * @param int $id
     * @param string $inserted_on
     * @param int $quantity
     * @param string $updated_on
     */
    public function __construct(\Canpar\Rate\StructType\CommodityInfo $commodity_info = null, $id = null, $inserted_on = null, $quantity = null, $updated_on = null)
    {
        $this
     ...
     * @return \Canpar\Rate\StructType\CommodityInfo|null
     */
     ...
     * @param \Canpar\Rate\StructType\CommodityInfo $commodity_info
     * @return \Canpar\Rate\StructType\ProformaItem
     */
    public function setCommodity_info(\Canpar\Rate\StructType\CommodityInfo $commodity_info = null)
    {
