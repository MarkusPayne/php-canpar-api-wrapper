...
/**
 * This class stands for RateShipmentAllServicesRq StructType
 * @subpackage Structs
 */
class RateShipmentAllServicesRq extends AbstractStructBase
{
    /**
    ...
    public $user_id;
    /**
     * Constructor method for RateShipmentAllServicesRq
     * @uses RateShipmentAllServicesRq::setApply_association_discount()
     * @uses RateShipmentAllServicesRq::setApply_individual_discount()
     * @uses RateShipmentAllServicesRq::setApply_invoice_discount()
     * @uses RateShipmentAllServicesRq::setPassword()
     * @uses RateShipmentAllServicesRq::setShipment()
     * @uses RateShipmentAllServicesRq::setUser_id()
     ...
     */
    public function __construct($apply_association_discount = null, $apply_individual_discount = null, $apply_invoice_discount = null, $password = null, \Canpar\Rate\StructType\Shipment $shipment = null, $user_id = null)
    {
        $this
     ...
     * @param bool $apply_association_discount
     * @return \Canpar\Rate\StructType\RateShipmentAllServicesRq
     */
