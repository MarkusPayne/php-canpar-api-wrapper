...
class SearchCanadaPostResponse extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Canpar\Rate\StructType\SearchCanadaPostRs
     */
    public $return;
    /**
     * Constructor method for searchCanadaPostResponse
     * @uses SearchCanadaPostResponse::setReturn()
     * @param \Canpar\Rate\StructType\SearchCanadaPostRs $return
     */
    public function __construct(\Canpar\Rate\StructType\SearchCanadaPostRs $return = null)
    {
        $this
            ->setReturn($return);
    }
     ...
     * @return \Canpar\Rate\StructType\SearchCanadaPostRs|null
     */
     ...
     */
    public function setReturn(\Canpar\Rate\StructType\SearchCanadaPostRs $return = null)
    {
