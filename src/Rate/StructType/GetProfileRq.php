...
/**
 * This class stands for GetProfileRq StructType
 * @subpackage Structs
 */
class GetProfileRq extends AbstractStructBase
{
    /**
     * The password
    ...
    public $user_id;
    /**
     * Constructor method for GetProfileRq
     * @uses GetProfileRq::setPassword()
     * @uses GetProfileRq::setShipper_num()
     * @uses GetProfileRq::setUser_id()
     ...
     * @param string $password
     * @return \Canpar\Rate\StructType\GetProfileRq
     */
