...
/**
 * This class stands for SavePreferenceRq StructType
 * @subpackage Structs
 */
class SavePreferenceRq extends AbstractStructBase
{
    /**
     * The password
    ...
    public $user_id;
    /**
     * Constructor method for SavePreferenceRq
     * @uses SavePreferenceRq::setPassword()
     * @uses SavePreferenceRq::setPreference()
     * @uses SavePreferenceRq::setUser_id()
     ...
     * @param string $password
     * @return \Canpar\Ship\StructType\SavePreferenceRq
     */
