...
/**
 * This class stands for SearchShipmentsByDeliveryNameRq StructType
 * @subpackage Structs
 */
class SearchShipmentsByDeliveryNameRq extends AbstractStructBase
{
    /**
    ...
    public $user_id;
    /**
     * Constructor method for SearchShipmentsByDeliveryNameRq
     * @uses SearchShipmentsByDeliveryNameRq::setFrom_shipping_date()
     * @uses SearchShipmentsByDeliveryNameRq::setName()
     * @uses SearchShipmentsByDeliveryNameRq::setPage_num()
     * @uses SearchShipmentsByDeliveryNameRq::setPassword()
     * @uses SearchShipmentsByDeliveryNameRq::setShipper_num()
     * @uses SearchShipmentsByDeliveryNameRq::setTo_shipping_date()
     * @uses SearchShipmentsByDeliveryNameRq::setUser_id()
     ...
     */
    public function __construct($from_shipping_date = null, $name = null, $page_num = null, $password = null, $shipper_num = null, $to_shipping_date = null, $user_id = null)
    {
        $this
     ...
     * @param string $from_shipping_date
     * @return \Canpar\Ship\StructType\SearchShipmentsByDeliveryNameRq
     */
