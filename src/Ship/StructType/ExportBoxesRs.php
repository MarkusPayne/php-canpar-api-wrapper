...
/**
 * This class stands for ExportBoxesRs StructType
 * @subpackage Structs
 */
class ExportBoxesRs extends AbstractStructBase
{
    /**
     * The error
    ...
    public $file;
    /**
     * Constructor method for ExportBoxesRs
     * @uses ExportBoxesRs::setError()
     * @uses ExportBoxesRs::setFile()
     * @param string $error
     * @param string $file
     */
     ...
     * @param string $error
     * @return \Canpar\Ship\StructType\ExportBoxesRs
     */
