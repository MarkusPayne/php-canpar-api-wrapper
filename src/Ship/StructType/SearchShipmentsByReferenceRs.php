...
/**
 * This class stands for SearchShipmentsByReferenceRs StructType
 * @subpackage Structs
 */
class SearchShipmentsByReferenceRs extends AbstractStructBase
{
    /**
     * The error
    ...
    public $shipment;
    /**
     * Constructor method for SearchShipmentsByReferenceRs
     * @uses SearchShipmentsByReferenceRs::setError()
     * @uses SearchShipmentsByReferenceRs::setShipment()
     * @param string $error
     ...
     * @param string $error
     * @return \Canpar\Ship\StructType\SearchShipmentsByReferenceRs
     */
    ...
    public static function validateShipmentForArrayConstraintsFromSetShipment(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $searchShipmentsByReferenceRsShipmentItem) {
            // validation for constraint: itemType
            if (!$searchShipmentsByReferenceRsShipmentItem instanceof \Canpar\Ship\StructType\Shipment) {
                $invalidValues[] = is_object($searchShipmentsByReferenceRsShipmentItem) ? get_class($searchShipmentsByReferenceRsShipmentItem) : sprintf('%s(%s)', gettype($searchShipmentsByReferenceRsShipmentItem), var_export($searchShipmentsByReferenceRsShipmentItem, true));
            }
        }
