...
/**
 * This class stands for GetBoxesRq StructType
 * @subpackage Structs
 */
class GetBoxesRq extends AbstractStructBase
{
    /**
     * The password
    ...
    public $user_id;
    /**
     * Constructor method for GetBoxesRq
     * @uses GetBoxesRq::setPassword()
     * @uses GetBoxesRq::setShipper_num()
     * @uses GetBoxesRq::setUser_id()
     ...
     * @param string $password
     * @return \Canpar\Ship\StructType\GetBoxesRq
     */
    ...
    public static function validateShipper_numForArrayConstraintsFromSetShipper_num(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $getBoxesRqShipper_numItem) {
            // validation for constraint: itemType
            if (!is_string($getBoxesRqShipper_numItem)) {
                $invalidValues[] = is_object($getBoxesRqShipper_numItem) ? get_class($getBoxesRqShipper_numItem) : sprintf('%s(%s)', gettype($getBoxesRqShipper_numItem), var_export($getBoxesRqShipper_numItem, true));
            }
        }
