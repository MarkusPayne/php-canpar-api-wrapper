...
/**
 * This class stands for SearchShipmentsByShippingDateRs StructType
 * @subpackage Structs
 */
class SearchShipmentsByShippingDateRs extends AbstractStructBase
{
    /**
     * The error
    ...
    public $shipment;
    /**
     * Constructor method for SearchShipmentsByShippingDateRs
     * @uses SearchShipmentsByShippingDateRs::setError()
     * @uses SearchShipmentsByShippingDateRs::setShipment()
     * @param string $error
     ...
     * @param string $error
     * @return \Canpar\Ship\StructType\SearchShipmentsByShippingDateRs
     */
    ...
    public static function validateShipmentForArrayConstraintsFromSetShipment(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $searchShipmentsByShippingDateRsShipmentItem) {
            // validation for constraint: itemType
            if (!$searchShipmentsByShippingDateRsShipmentItem instanceof \Canpar\Ship\StructType\Shipment) {
                $invalidValues[] = is_object($searchShipmentsByShippingDateRsShipmentItem) ? get_class($searchShipmentsByShippingDateRsShipmentItem) : sprintf('%s(%s)', gettype($searchShipmentsByShippingDateRsShipmentItem), var_export($searchShipmentsByShippingDateRsShipmentItem, true));
            }
        }
