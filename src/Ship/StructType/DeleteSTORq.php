...
/**
 * This class stands for DeleteSTORq StructType
 * @subpackage Structs
 */
class DeleteSTORq extends AbstractStructBase
{
    /**
     * The name
    ...
    public $user_id;
    /**
     * Constructor method for DeleteSTORq
     * @uses DeleteSTORq::setName()
     * @uses DeleteSTORq::setPassword()
     * @uses DeleteSTORq::setShipper_num()
     * @uses DeleteSTORq::setUser_id()
     * @param string $name
     ...
     * @param string $name
     * @return \Canpar\Ship\StructType\DeleteSTORq
     */
