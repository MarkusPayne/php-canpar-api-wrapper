...
/**
 * This class stands for SearchShipmentsByShippingDateRq StructType
 * @subpackage Structs
 */
class SearchShipmentsByShippingDateRq extends AbstractStructBase
{
    /**
    ...
    public $user_id;
    /**
     * Constructor method for SearchShipmentsByShippingDateRq
     * @uses SearchShipmentsByShippingDateRq::setFrom_shipping_date()
     * @uses SearchShipmentsByShippingDateRq::setPage_num()
     * @uses SearchShipmentsByShippingDateRq::setPassword()
     * @uses SearchShipmentsByShippingDateRq::setShipper_num()
     * @uses SearchShipmentsByShippingDateRq::setTo_shipping_date()
     * @uses SearchShipmentsByShippingDateRq::setUser_id()
     ...
     */
    public function __construct($from_shipping_date = null, $page_num = null, $password = null, $shipper_num = null, $to_shipping_date = null, $user_id = null)
    {
        $this
     ...
     * @param string $from_shipping_date
     * @return \Canpar\Ship\StructType\SearchShipmentsByShippingDateRq
     */
