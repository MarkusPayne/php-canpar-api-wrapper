...
/**
 * This class stands for ImportCostCentresRq StructType
 * @subpackage Structs
 */
class ImportCostCentresRq extends AbstractStructBase
{
    /**
    ...
    public $user_id;
    /**
     * Constructor method for ImportCostCentresRq
     * @uses ImportCostCentresRq::setDelete_all_before()
     * @uses ImportCostCentresRq::setFile()
     * @uses ImportCostCentresRq::setPassword()
     * @uses ImportCostCentresRq::setShipper_num()
     * @uses ImportCostCentresRq::setType()
     * @uses ImportCostCentresRq::setUser_id()
     ...
     */
    public function __construct($delete_all_before = null, $file = null, $password = null, $shipper_num = null, $type = null, $user_id = null)
    {
        $this
     ...
     * @param bool $delete_all_before
     * @return \Canpar\Ship\StructType\ImportCostCentresRq
     */
