...
/**
 * This class stands for SearchShipmentsByManifestNumRs StructType
 * @subpackage Structs
 */
class SearchShipmentsByManifestNumRs extends AbstractStructBase
{
    /**
     * The error
    ...
    public $shipment;
    /**
     * Constructor method for SearchShipmentsByManifestNumRs
     * @uses SearchShipmentsByManifestNumRs::setError()
     * @uses SearchShipmentsByManifestNumRs::setShipment()
     * @param string $error
     ...
     * @param string $error
     * @return \Canpar\Ship\StructType\SearchShipmentsByManifestNumRs
     */
    ...
    public static function validateShipmentForArrayConstraintsFromSetShipment(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $searchShipmentsByManifestNumRsShipmentItem) {
            // validation for constraint: itemType
            if (!$searchShipmentsByManifestNumRsShipmentItem instanceof \Canpar\Ship\StructType\Shipment) {
                $invalidValues[] = is_object($searchShipmentsByManifestNumRsShipmentItem) ? get_class($searchShipmentsByManifestNumRsShipmentItem) : sprintf('%s(%s)', gettype($searchShipmentsByManifestNumRsShipmentItem), var_export($searchShipmentsByManifestNumRsShipmentItem, true));
            }
        }
