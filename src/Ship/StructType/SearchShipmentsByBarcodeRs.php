...
/**
 * This class stands for SearchShipmentsByBarcodeRs StructType
 * @subpackage Structs
 */
class SearchShipmentsByBarcodeRs extends AbstractStructBase
{
    /**
     * The error
    ...
    public $shipment;
    /**
     * Constructor method for SearchShipmentsByBarcodeRs
     * @uses SearchShipmentsByBarcodeRs::setError()
     * @uses SearchShipmentsByBarcodeRs::setShipment()
     * @param string $error
     ...
     * @param string $error
     * @return \Canpar\Ship\StructType\SearchShipmentsByBarcodeRs
     */
    ...
    public static function validateShipmentForArrayConstraintsFromSetShipment(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $searchShipmentsByBarcodeRsShipmentItem) {
            // validation for constraint: itemType
            if (!$searchShipmentsByBarcodeRsShipmentItem instanceof \Canpar\Ship\StructType\Shipment) {
                $invalidValues[] = is_object($searchShipmentsByBarcodeRsShipmentItem) ? get_class($searchShipmentsByBarcodeRsShipmentItem) : sprintf('%s(%s)', gettype($searchShipmentsByBarcodeRsShipmentItem), var_export($searchShipmentsByBarcodeRsShipmentItem, true));
            }
        }
