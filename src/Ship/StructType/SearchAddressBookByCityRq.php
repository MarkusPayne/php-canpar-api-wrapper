...
/**
 * This class stands for SearchAddressBookByCityRq StructType
 * @subpackage Structs
 */
class SearchAddressBookByCityRq extends AbstractStructBase
{
    /**
     * The city
    ...
    public $user_id;
    /**
     * Constructor method for SearchAddressBookByCityRq
     * @uses SearchAddressBookByCityRq::setCity()
     * @uses SearchAddressBookByCityRq::setPage_num()
     * @uses SearchAddressBookByCityRq::setPassword()
     * @uses SearchAddressBookByCityRq::setShipper_num()
     * @uses SearchAddressBookByCityRq::setUser_id()
     * @param string $city
     * @param int $page_num
     ...
     */
    public function __construct($city = null, $page_num = null, $password = null, array $shipper_num = array(), $user_id = null)
    {
        $this
            ->setCity($city)
     ...
     * @param string $city
     * @return \Canpar\Ship\StructType\SearchAddressBookByCityRq
     */
    ...
    public static function validateShipper_numForArrayConstraintsFromSetShipper_num(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $searchAddressBookByCityRqShipper_numItem) {
            // validation for constraint: itemType
            if (!is_string($searchAddressBookByCityRqShipper_numItem)) {
                $invalidValues[] = is_object($searchAddressBookByCityRqShipper_numItem) ? get_class($searchAddressBookByCityRqShipper_numItem) : sprintf('%s(%s)', gettype($searchAddressBookByCityRqShipper_numItem), var_export($searchAddressBookByCityRqShipper_numItem, true));
            }
        }
