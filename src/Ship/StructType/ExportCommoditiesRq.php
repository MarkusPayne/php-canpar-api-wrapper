...
/**
 * This class stands for ExportCommoditiesRq StructType
 * @subpackage Structs
 */
class ExportCommoditiesRq extends AbstractStructBase
{
    /**
     * The password
    ...
    public $user_id;
    /**
     * Constructor method for ExportCommoditiesRq
     * @uses ExportCommoditiesRq::setPassword()
     * @uses ExportCommoditiesRq::setShipper_num()
     * @uses ExportCommoditiesRq::setType()
     * @uses ExportCommoditiesRq::setUser_id()
     ...
     * @param string $password
     * @return \Canpar\Ship\StructType\ExportCommoditiesRq
     */
