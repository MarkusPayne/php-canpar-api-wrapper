...
/**
 * This class stands for ExportCostCentresRq StructType
 * @subpackage Structs
 */
class ExportCostCentresRq extends AbstractStructBase
{
    /**
     * The password
    ...
    public $user_id;
    /**
     * Constructor method for ExportCostCentresRq
     * @uses ExportCostCentresRq::setPassword()
     * @uses ExportCostCentresRq::setShipper_num()
     * @uses ExportCostCentresRq::setType()
     * @uses ExportCostCentresRq::setUser_id()
     ...
     * @param string $password
     * @return \Canpar\Ship\StructType\ExportCostCentresRq
     */
