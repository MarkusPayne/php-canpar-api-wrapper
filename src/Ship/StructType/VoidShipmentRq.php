...
/**
 * This class stands for VoidShipmentRq StructType
 * @subpackage Structs
 */
class VoidShipmentRq extends AbstractStructBase
{
    /**
     * The id
    ...
    public $user_id;
    /**
     * Constructor method for VoidShipmentRq
     * @uses VoidShipmentRq::setId()
     * @uses VoidShipmentRq::setPassword()
     * @uses VoidShipmentRq::setUser_id()
     * @param int $id
     ...
     * Set id value
     * @param int $id
     * @return \Canpar\Ship\StructType\VoidShipmentRq
     */
