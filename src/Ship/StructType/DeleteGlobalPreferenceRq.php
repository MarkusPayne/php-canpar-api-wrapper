...
/**
 * This class stands for DeleteGlobalPreferenceRq StructType
 * @subpackage Structs
 */
class DeleteGlobalPreferenceRq extends AbstractStructBase
{
    /**
    ...
    public $user_id;
    /**
     * Constructor method for DeleteGlobalPreferenceRq
     * @uses DeleteGlobalPreferenceRq::setGlobal_preference_user_id()
     * @uses DeleteGlobalPreferenceRq::setPassword()
     * @uses DeleteGlobalPreferenceRq::setUser_id()
     ...
     * @param string $global_preference_user_id
     * @return \Canpar\Ship\StructType\DeleteGlobalPreferenceRq
     */
