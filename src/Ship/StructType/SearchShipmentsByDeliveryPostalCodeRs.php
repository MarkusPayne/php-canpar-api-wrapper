...
/**
 * This class stands for SearchShipmentsByDeliveryPostalCodeRs StructType
 * @subpackage Structs
 */
class SearchShipmentsByDeliveryPostalCodeRs extends AbstractStructBase
{
    /**
     * The error
    ...
    public $shipment;
    /**
     * Constructor method for SearchShipmentsByDeliveryPostalCodeRs
     * @uses SearchShipmentsByDeliveryPostalCodeRs::setError()
     * @uses SearchShipmentsByDeliveryPostalCodeRs::setShipment()
     * @param string $error
     ...
     * @param string $error
     * @return \Canpar\Ship\StructType\SearchShipmentsByDeliveryPostalCodeRs
     */
    ...
    public static function validateShipmentForArrayConstraintsFromSetShipment(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $searchShipmentsByDeliveryPostalCodeRsShipmentItem) {
            // validation for constraint: itemType
            if (!$searchShipmentsByDeliveryPostalCodeRsShipmentItem instanceof \Canpar\Ship\StructType\Shipment) {
                $invalidValues[] = is_object($searchShipmentsByDeliveryPostalCodeRsShipmentItem) ? get_class($searchShipmentsByDeliveryPostalCodeRsShipmentItem) : sprintf('%s(%s)', gettype($searchShipmentsByDeliveryPostalCodeRsShipmentItem), var_export($searchShipmentsByDeliveryPostalCodeRsShipmentItem, true));
            }
        }
