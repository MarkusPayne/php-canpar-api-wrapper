...
/**
 * This class stands for SaveSTORq StructType
 * @subpackage Structs
 */
class SaveSTORq extends AbstractStructBase
{
    /**
     * The password
    ...
    public $user_id;
    /**
     * Constructor method for SaveSTORq
     * @uses SaveSTORq::setPassword()
     * @uses SaveSTORq::setSto()
     * @uses SaveSTORq::setUser_id()
     * @param string $password
     * @param \Canpar\Ship\StructType\STO $sto
     * @param string $user_id
     */
    public function __construct($password = null, \Canpar\Ship\StructType\STO $sto = null, $user_id = null)
    {
        $this
     ...
     * @param string $password
     * @return \Canpar\Ship\StructType\SaveSTORq
     */
