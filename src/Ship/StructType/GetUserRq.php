...
/**
 * This class stands for GetUserRq StructType
 * @subpackage Structs
 */
class GetUserRq extends AbstractStructBase
{
    /**
     * The id
    ...
    public $user_id;
    /**
     * Constructor method for GetUserRq
     * @uses GetUserRq::setId()
     * @uses GetUserRq::setPassword()
     * @uses GetUserRq::setUser_id()
     * @param string $id
     ...
     * @param string $id
     * @return \Canpar\Ship\StructType\GetUserRq
     */
