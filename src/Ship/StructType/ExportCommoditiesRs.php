...
/**
 * This class stands for ExportCommoditiesRs StructType
 * @subpackage Structs
 */
class ExportCommoditiesRs extends AbstractStructBase
{
    /**
     * The error
    ...
    public $file;
    /**
     * Constructor method for ExportCommoditiesRs
     * @uses ExportCommoditiesRs::setError()
     * @uses ExportCommoditiesRs::setFile()
     * @param string $error
     * @param string $file
     */
     ...
     * @param string $error
     * @return \Canpar\Ship\StructType\ExportCommoditiesRs
     */
