...
/**
 * This class stands for GetProformaRq StructType
 * @subpackage Structs
 */
class GetProformaRq extends AbstractStructBase
{
    /**
     * The id
    ...
    public $user_id;
    /**
     * Constructor method for GetProformaRq
     * @uses GetProformaRq::setId()
     * @uses GetProformaRq::setPassword()
     * @uses GetProformaRq::setUser_id()
     * @param int $id
     ...
     * Set id value
     * @param int $id
     * @return \Canpar\Ship\StructType\GetProformaRq
     */
