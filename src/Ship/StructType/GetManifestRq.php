...
/**
 * This class stands for GetManifestRq StructType
 * @subpackage Structs
 */
class GetManifestRq extends AbstractStructBase
{
    /**
     * The manifest_num
    ...
    public $user_id;
    /**
     * Constructor method for GetManifestRq
     * @uses GetManifestRq::setManifest_num()
     * @uses GetManifestRq::setPassword()
     * @uses GetManifestRq::setShipper_num()
     * @uses GetManifestRq::setType()
     * @uses GetManifestRq::setUser_id()
     ...
     */
    public function __construct($manifest_num = null, $password = null, $shipper_num = null, $type = null, $user_id = null)
    {
        $this
     ...
     * @param string $manifest_num
     * @return \Canpar\Ship\StructType\GetManifestRq
     */
