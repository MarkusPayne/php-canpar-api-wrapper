...
/**
 * This class stands for SearchAddressBookByPhoneRs StructType
 * @subpackage Structs
 */
class SearchAddressBookByPhoneRs extends AbstractStructBase
{
    /**
     * The address
    ...
    public $error;
    /**
     * Constructor method for SearchAddressBookByPhoneRs
     * @uses SearchAddressBookByPhoneRs::setAddress()
     * @uses SearchAddressBookByPhoneRs::setError()
    ...
    public static function validateAddressForArrayConstraintsFromSetAddress(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $searchAddressBookByPhoneRsAddressItem) {
            // validation for constraint: itemType
            if (!$searchAddressBookByPhoneRsAddressItem instanceof \Canpar\Ship\StructType\AddressBook) {
                $invalidValues[] = is_object($searchAddressBookByPhoneRsAddressItem) ? get_class($searchAddressBookByPhoneRsAddressItem) : sprintf('%s(%s)', gettype($searchAddressBookByPhoneRsAddressItem), var_export($searchAddressBookByPhoneRsAddressItem, true));
            }
        }
     ...
     * @param \Canpar\Ship\StructType\AddressBook[] $address
     * @return \Canpar\Ship\StructType\SearchAddressBookByPhoneRs
     */
