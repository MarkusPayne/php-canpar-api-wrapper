...
/**
 * This class stands for GetShipmentsBeforeDayRq StructType
 * @subpackage Structs
 */
class GetShipmentsBeforeDayRq extends AbstractStructBase
{
    /**
     * The before
    ...
    public $user_id;
    /**
     * Constructor method for GetShipmentsBeforeDayRq
     * @uses GetShipmentsBeforeDayRq::setBefore()
     * @uses GetShipmentsBeforeDayRq::setPassword()
     * @uses GetShipmentsBeforeDayRq::setShipper_num()
     * @uses GetShipmentsBeforeDayRq::setUser_id()
     * @param string $before
     * @param string $password
     * @param string $shipper_num
     * @param string $user_id
     */
    public function __construct($before = null, $password = null, $shipper_num = null, $user_id = null)
    {
        $this
            ->setBefore($before)
    ...
    {
        return isset($this->before) ? $this->before : null;
    }
    /**
     * Set before value
     ...
     * @param string $before
     * @return \Canpar\Ship\StructType\GetShipmentsBeforeDayRq
     */
    public function setBefore($before = null)
    {
        // validation for constraint: string
        if (!is_null($before) && !is_string($before)) {
            throw new \InvalidArgumentException(sprintf('Invalid value %s, please provide a string, %s given', var_export($before, true), gettype($before)), __LINE__);
        }
        if (is_null($before) || (is_array($before) && empty($before))) {
            unset($this->before);
        } else {
            $this->before = $before;
        }
