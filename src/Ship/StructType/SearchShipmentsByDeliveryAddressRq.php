...
/**
 * This class stands for SearchShipmentsByDeliveryAddressRq StructType
 * @subpackage Structs
 */
class SearchShipmentsByDeliveryAddressRq extends AbstractStructBase
{
    /**
     * The address_line
    ...
    public $user_id;
    /**
     * Constructor method for SearchShipmentsByDeliveryAddressRq
     * @uses SearchShipmentsByDeliveryAddressRq::setAddress_line()
     * @uses SearchShipmentsByDeliveryAddressRq::setFrom_shipping_date()
     * @uses SearchShipmentsByDeliveryAddressRq::setPage_num()
     * @uses SearchShipmentsByDeliveryAddressRq::setPassword()
     * @uses SearchShipmentsByDeliveryAddressRq::setShipper_num()
     * @uses SearchShipmentsByDeliveryAddressRq::setTo_shipping_date()
     * @uses SearchShipmentsByDeliveryAddressRq::setUser_id()
     ...
     */
    public function __construct($address_line = null, $from_shipping_date = null, $page_num = null, $password = null, $shipper_num = null, $to_shipping_date = null, $user_id = null)
    {
        $this
    ...
    {
        return isset($this->address_line) ? $this->address_line : null;
    }
    /**
     ...
     * @param string $address_line
     * @return \Canpar\Ship\StructType\SearchShipmentsByDeliveryAddressRq
     */
    public function setAddress_line($address_line = null)
    {
        // validation for constraint: string
        if (!is_null($address_line) && !is_string($address_line)) {
            throw new \InvalidArgumentException(sprintf('Invalid value %s, please provide a string, %s given', var_export($address_line, true), gettype($address_line)), __LINE__);
        }
        if (is_null($address_line) || (is_array($address_line) && empty($address_line))) {
            unset($this->address_line);
        } else {
