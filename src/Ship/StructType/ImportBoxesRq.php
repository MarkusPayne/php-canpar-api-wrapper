...
/**
 * This class stands for ImportBoxesRq StructType
 * @subpackage Structs
 */
class ImportBoxesRq extends AbstractStructBase
{
    /**
    ...
    public $user_id;
    /**
     * Constructor method for ImportBoxesRq
     * @uses ImportBoxesRq::setDelete_all_before()
     * @uses ImportBoxesRq::setFile()
     * @uses ImportBoxesRq::setPassword()
     * @uses ImportBoxesRq::setShipper_num()
     * @uses ImportBoxesRq::setType()
     * @uses ImportBoxesRq::setUser_id()
     ...
     * @param bool $delete_all_before
     * @return \Canpar\Ship\StructType\ImportBoxesRq
     */
