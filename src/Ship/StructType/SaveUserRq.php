...
/**
 * This class stands for SaveUserRq StructType
 * @subpackage Structs
 */
class SaveUserRq extends AbstractStructBase
{
    /**
     * The password
    ...
    public $user_id;
    /**
     * Constructor method for SaveUserRq
     * @uses SaveUserRq::setPassword()
     * @uses SaveUserRq::setShipper_num()
     * @uses SaveUserRq::setUser()
     * @uses SaveUserRq::setUser_id()
     * @param string $password
     * @param string[] $shipper_num
     * @param \Canpar\Ship\StructType\CanshipUser $user
     * @param string $user_id
     */
    public function __construct($password = null, array $shipper_num = array(), \Canpar\Ship\StructType\CanshipUser $user = null, $user_id = null)
    {
        $this
     ...
     * @param string $password
     * @return \Canpar\Ship\StructType\SaveUserRq
     */
    ...
    public static function validateShipper_numForArrayConstraintsFromSetShipper_num(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $saveUserRqShipper_numItem) {
            // validation for constraint: itemType
            if (!is_string($saveUserRqShipper_numItem)) {
                $invalidValues[] = is_object($saveUserRqShipper_numItem) ? get_class($saveUserRqShipper_numItem) : sprintf('%s(%s)', gettype($saveUserRqShipper_numItem), var_export($saveUserRqShipper_numItem, true));
            }
        }
