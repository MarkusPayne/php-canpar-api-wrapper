...
/**
 * This class stands for SaveUserRs StructType
 * @subpackage Structs
 */
class SaveUserRs extends AbstractStructBase
{
    /**
     * The error
    ...
    public $user;
    /**
     * Constructor method for SaveUserRs
     * @uses SaveUserRs::setError()
     * @uses SaveUserRs::setUser()
     * @param string $error
     ...
     * @param string $error
     * @return \Canpar\Ship\StructType\SaveUserRs
     */
