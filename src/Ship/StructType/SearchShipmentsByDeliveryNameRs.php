...
/**
 * This class stands for SearchShipmentsByDeliveryNameRs StructType
 * @subpackage Structs
 */
class SearchShipmentsByDeliveryNameRs extends AbstractStructBase
{
    /**
     * The error
    ...
    public $shipment;
    /**
     * Constructor method for SearchShipmentsByDeliveryNameRs
     * @uses SearchShipmentsByDeliveryNameRs::setError()
     * @uses SearchShipmentsByDeliveryNameRs::setShipment()
     * @param string $error
     ...
     * @param string $error
     * @return \Canpar\Ship\StructType\SearchShipmentsByDeliveryNameRs
     */
    ...
    public static function validateShipmentForArrayConstraintsFromSetShipment(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $searchShipmentsByDeliveryNameRsShipmentItem) {
            // validation for constraint: itemType
            if (!$searchShipmentsByDeliveryNameRsShipmentItem instanceof \Canpar\Ship\StructType\Shipment) {
                $invalidValues[] = is_object($searchShipmentsByDeliveryNameRsShipmentItem) ? get_class($searchShipmentsByDeliveryNameRsShipmentItem) : sprintf('%s(%s)', gettype($searchShipmentsByDeliveryNameRsShipmentItem), var_export($searchShipmentsByDeliveryNameRsShipmentItem, true));
            }
        }
