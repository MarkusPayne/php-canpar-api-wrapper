...
/**
 * This class stands for GetShipmentsAfterDayRs StructType
 * @subpackage Structs
 */
class GetShipmentsAfterDayRs extends AbstractStructBase
{
    /**
     * The error
    ...
    public $shipment;
    /**
     * Constructor method for GetShipmentsAfterDayRs
     * @uses GetShipmentsAfterDayRs::setError()
     * @uses GetShipmentsAfterDayRs::setShipment()
     * @param string $error
     ...
     * @param string $error
     * @return \Canpar\Ship\StructType\GetShipmentsAfterDayRs
     */
    ...
    public static function validateShipmentForArrayConstraintsFromSetShipment(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $getShipmentsAfterDayRsShipmentItem) {
            // validation for constraint: itemType
            if (!$getShipmentsAfterDayRsShipmentItem instanceof \Canpar\Ship\StructType\Shipment) {
                $invalidValues[] = is_object($getShipmentsAfterDayRsShipmentItem) ? get_class($getShipmentsAfterDayRsShipmentItem) : sprintf('%s(%s)', gettype($getShipmentsAfterDayRsShipmentItem), var_export($getShipmentsAfterDayRsShipmentItem, true));
            }
        }
