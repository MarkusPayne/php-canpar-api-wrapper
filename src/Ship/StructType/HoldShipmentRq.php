...
/**
 * This class stands for HoldShipmentRq StructType
 * @subpackage Structs
 */
class HoldShipmentRq extends AbstractStructBase
{
    /**
     * The password
    ...
    public $user_id;
    /**
     * Constructor method for HoldShipmentRq
     * @uses HoldShipmentRq::setPassword()
     * @uses HoldShipmentRq::setShipment()
     * @uses HoldShipmentRq::setUser_id()
     * @param string $password
     * @param \Canpar\Ship\StructType\Shipment $shipment
     * @param string $user_id
     */
    public function __construct($password = null, \Canpar\Ship\StructType\Shipment $shipment = null, $user_id = null)
    {
        $this
     ...
     * @param string $password
     * @return \Canpar\Ship\StructType\HoldShipmentRq
     */
