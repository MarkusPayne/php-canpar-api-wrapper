...
/**
 * This class stands for SearchShipmentsByDeliveryProvinceRs StructType
 * @subpackage Structs
 */
class SearchShipmentsByDeliveryProvinceRs extends AbstractStructBase
{
    /**
     * The error
    ...
    public $shipment;
    /**
     * Constructor method for SearchShipmentsByDeliveryProvinceRs
     * @uses SearchShipmentsByDeliveryProvinceRs::setError()
     * @uses SearchShipmentsByDeliveryProvinceRs::setShipment()
     * @param string $error
     ...
     * @param string $error
     * @return \Canpar\Ship\StructType\SearchShipmentsByDeliveryProvinceRs
     */
    ...
    public static function validateShipmentForArrayConstraintsFromSetShipment(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $searchShipmentsByDeliveryProvinceRsShipmentItem) {
            // validation for constraint: itemType
            if (!$searchShipmentsByDeliveryProvinceRsShipmentItem instanceof \Canpar\Ship\StructType\Shipment) {
                $invalidValues[] = is_object($searchShipmentsByDeliveryProvinceRsShipmentItem) ? get_class($searchShipmentsByDeliveryProvinceRsShipmentItem) : sprintf('%s(%s)', gettype($searchShipmentsByDeliveryProvinceRsShipmentItem), var_export($searchShipmentsByDeliveryProvinceRsShipmentItem, true));
            }
        }
