...
/**
 * This class stands for SearchAddressBookByReferenceRs StructType
 * @subpackage Structs
 */
class SearchAddressBookByReferenceRs extends AbstractStructBase
{
    /**
     * The address
    ...
    public $error;
    /**
     * Constructor method for SearchAddressBookByReferenceRs
     * @uses SearchAddressBookByReferenceRs::setAddress()
     * @uses SearchAddressBookByReferenceRs::setError()
    ...
    public static function validateAddressForArrayConstraintsFromSetAddress(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $searchAddressBookByReferenceRsAddressItem) {
            // validation for constraint: itemType
            if (!$searchAddressBookByReferenceRsAddressItem instanceof \Canpar\Ship\StructType\AddressBook) {
                $invalidValues[] = is_object($searchAddressBookByReferenceRsAddressItem) ? get_class($searchAddressBookByReferenceRsAddressItem) : sprintf('%s(%s)', gettype($searchAddressBookByReferenceRsAddressItem), var_export($searchAddressBookByReferenceRsAddressItem, true));
            }
        }
     ...
     * @param \Canpar\Ship\StructType\AddressBook[] $address
     * @return \Canpar\Ship\StructType\SearchAddressBookByReferenceRs
     */
