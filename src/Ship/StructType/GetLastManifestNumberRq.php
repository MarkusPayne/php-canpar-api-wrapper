...
/**
 * This class stands for GetLastManifestNumberRq StructType
 * @subpackage Structs
 */
class GetLastManifestNumberRq extends AbstractStructBase
{
    /**
     * The password
    ...
    public $user_id;
    /**
     * Constructor method for GetLastManifestNumberRq
     * @uses GetLastManifestNumberRq::setPassword()
     * @uses GetLastManifestNumberRq::setShipper_num()
     * @uses GetLastManifestNumberRq::setUser_id()
     * @param string $password
     * @param string $shipper_num
     * @param string $user_id
     */
    public function __construct($password = null, $shipper_num = null, $user_id = null)
    {
        $this
     ...
     * @param string $password
     * @return \Canpar\Ship\StructType\GetLastManifestNumberRq
     */
