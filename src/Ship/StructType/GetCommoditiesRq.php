...
/**
 * This class stands for GetCommoditiesRq StructType
 * @subpackage Structs
 */
class GetCommoditiesRq extends AbstractStructBase
{
    /**
     * The password
    ...
    public $user_id;
    /**
     * Constructor method for GetCommoditiesRq
     * @uses GetCommoditiesRq::setPassword()
     * @uses GetCommoditiesRq::setShipper_num()
     * @uses GetCommoditiesRq::setUser_id()
     ...
     * @param string $password
     * @return \Canpar\Ship\StructType\GetCommoditiesRq
     */
    ...
    public static function validateShipper_numForArrayConstraintsFromSetShipper_num(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $getCommoditiesRqShipper_numItem) {
            // validation for constraint: itemType
            if (!is_string($getCommoditiesRqShipper_numItem)) {
                $invalidValues[] = is_object($getCommoditiesRqShipper_numItem) ? get_class($getCommoditiesRqShipper_numItem) : sprintf('%s(%s)', gettype($getCommoditiesRqShipper_numItem), var_export($getCommoditiesRqShipper_numItem, true));
            }
        }
