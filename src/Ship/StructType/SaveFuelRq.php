...
/**
 * This class stands for SaveFuelRq StructType
 * @subpackage Structs
 */
class SaveFuelRq extends AbstractStructBase
{
    /**
     * The fuel
    ...
    public $user_id;
    /**
     * Constructor method for SaveFuelRq
     * @uses SaveFuelRq::setFuel()
     * @uses SaveFuelRq::setPassword()
     * @uses SaveFuelRq::setUser_id()
     * @param \Canpar\Ship\StructType\Fuel $fuel
     * @param string $password
     * @param string $user_id
     */
    public function __construct(\Canpar\Ship\StructType\Fuel $fuel = null, $password = null, $user_id = null)
    {
        $this
            ->setFuel($fuel)
     ...
     * @param \Canpar\Ship\StructType\Fuel $fuel
     * @return \Canpar\Ship\StructType\SaveFuelRq
     */
