...
/**
 * This class stands for SearchAddressBookByProvinceRq StructType
 * @subpackage Structs
 */
class SearchAddressBookByProvinceRq extends AbstractStructBase
{
    /**
     * The page_num
    ...
    public $user_id;
    /**
     * Constructor method for SearchAddressBookByProvinceRq
     * @uses SearchAddressBookByProvinceRq::setPage_num()
     * @uses SearchAddressBookByProvinceRq::setPassword()
     * @uses SearchAddressBookByProvinceRq::setProvince()
     * @uses SearchAddressBookByProvinceRq::setShipper_num()
     * @uses SearchAddressBookByProvinceRq::setUser_id()
     * @param int $page_num
     ...
     */
    public function __construct($page_num = null, $password = null, $province = null, array $shipper_num = array(), $user_id = null)
    {
        $this
     ...
     * Set page_num value
     * @param int $page_num
     * @return \Canpar\Ship\StructType\SearchAddressBookByProvinceRq
     */
    ...
    public static function validateShipper_numForArrayConstraintsFromSetShipper_num(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $searchAddressBookByProvinceRqShipper_numItem) {
            // validation for constraint: itemType
            if (!is_string($searchAddressBookByProvinceRqShipper_numItem)) {
                $invalidValues[] = is_object($searchAddressBookByProvinceRqShipper_numItem) ? get_class($searchAddressBookByProvinceRqShipper_numItem) : sprintf('%s(%s)', gettype($searchAddressBookByProvinceRqShipper_numItem), var_export($searchAddressBookByProvinceRqShipper_numItem, true));
            }
        }
