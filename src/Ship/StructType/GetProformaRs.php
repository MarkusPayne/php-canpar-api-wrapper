...
/**
 * This class stands for GetProformaRs StructType
 * @subpackage Structs
 */
class GetProformaRs extends AbstractStructBase
{
    /**
     * The error
    ...
    public $proforma;
    /**
     * Constructor method for GetProformaRs
     * @uses GetProformaRs::setError()
     * @uses GetProformaRs::setProforma()
     * @param string $error
     ...
     * @param string $error
     * @return \Canpar\Ship\StructType\GetProformaRs
     */
