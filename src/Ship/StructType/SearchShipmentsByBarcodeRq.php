...
/**
 * This class stands for SearchShipmentsByBarcodeRq StructType
 * @subpackage Structs
 */
class SearchShipmentsByBarcodeRq extends AbstractStructBase
{
    /**
     * The barcode
    ...
    public $user_id;
    /**
     * Constructor method for SearchShipmentsByBarcodeRq
     * @uses SearchShipmentsByBarcodeRq::setBarcode()
     * @uses SearchShipmentsByBarcodeRq::setFrom_shipping_date()
     * @uses SearchShipmentsByBarcodeRq::setPage_num()
     * @uses SearchShipmentsByBarcodeRq::setPassword()
     * @uses SearchShipmentsByBarcodeRq::setShipper_num()
     * @uses SearchShipmentsByBarcodeRq::setTo_shipping_date()
     * @uses SearchShipmentsByBarcodeRq::setUser_id()
     ...
     */
    public function __construct($barcode = null, $from_shipping_date = null, $page_num = null, $password = null, $shipper_num = null, $to_shipping_date = null, $user_id = null)
    {
        $this
            ->setBarcode($barcode)
     ...
     * @param string $barcode
     * @return \Canpar\Ship\StructType\SearchShipmentsByBarcodeRq
     */
