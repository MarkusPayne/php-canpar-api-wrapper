...
/**
 * This class stands for SearchAddressBookByNameRs StructType
 * @subpackage Structs
 */
class SearchAddressBookByNameRs extends AbstractStructBase
{
    /**
     * The address
    ...
    public $error;
    /**
     * Constructor method for SearchAddressBookByNameRs
     * @uses SearchAddressBookByNameRs::setAddress()
     * @uses SearchAddressBookByNameRs::setError()
    ...
    public static function validateAddressForArrayConstraintsFromSetAddress(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $searchAddressBookByNameRsAddressItem) {
            // validation for constraint: itemType
            if (!$searchAddressBookByNameRsAddressItem instanceof \Canpar\Ship\StructType\AddressBook) {
                $invalidValues[] = is_object($searchAddressBookByNameRsAddressItem) ? get_class($searchAddressBookByNameRsAddressItem) : sprintf('%s(%s)', gettype($searchAddressBookByNameRsAddressItem), var_export($searchAddressBookByNameRsAddressItem, true));
            }
        }
     ...
     * @param \Canpar\Ship\StructType\AddressBook[] $address
     * @return \Canpar\Ship\StructType\SearchAddressBookByNameRs
     */
