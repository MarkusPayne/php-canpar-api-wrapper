...
/**
 * This class stands for SaveProformaRq StructType
 * @subpackage Structs
 */
class SaveProformaRq extends AbstractStructBase
{
    /**
     * The id
    ...
    public $user_id;
    /**
     * Constructor method for SaveProformaRq
     * @uses SaveProformaRq::setId()
     * @uses SaveProformaRq::setPassword()
     * @uses SaveProformaRq::setProforma()
     * @uses SaveProformaRq::setUser_id()
     * @param int $id
     * @param string $password
     * @param \Canpar\Ship\StructType\Proforma $proforma
     * @param string $user_id
     */
    public function __construct($id = null, $password = null, \Canpar\Ship\StructType\Proforma $proforma = null, $user_id = null)
    {
        $this
            ->setId($id)
     ...
     * Set id value
     * @param int $id
     * @return \Canpar\Ship\StructType\SaveProformaRq
     */
