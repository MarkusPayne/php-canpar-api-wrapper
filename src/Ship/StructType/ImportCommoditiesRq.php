...
/**
 * This class stands for ImportCommoditiesRq StructType
 * @subpackage Structs
 */
class ImportCommoditiesRq extends AbstractStructBase
{
    /**
    ...
    public $validate;
    /**
     * Constructor method for ImportCommoditiesRq
     * @uses ImportCommoditiesRq::setDelete_all_before()
     * @uses ImportCommoditiesRq::setFile()
     * @uses ImportCommoditiesRq::setPassword()
     * @uses ImportCommoditiesRq::setShipper_num()
     * @uses ImportCommoditiesRq::setType()
     * @uses ImportCommoditiesRq::setUser_id()
     * @uses ImportCommoditiesRq::setValidate()
     ...
     * @param bool $delete_all_before
     * @return \Canpar\Ship\StructType\ImportCommoditiesRq
     */
