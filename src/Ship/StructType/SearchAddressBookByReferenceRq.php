...
/**
 * This class stands for SearchAddressBookByReferenceRq StructType
 * @subpackage Structs
 */
class SearchAddressBookByReferenceRq extends AbstractStructBase
{
    /**
     * The page_num
    ...
    public $user_id;
    /**
     * Constructor method for SearchAddressBookByReferenceRq
     * @uses SearchAddressBookByReferenceRq::setPage_num()
     * @uses SearchAddressBookByReferenceRq::setPassword()
     * @uses SearchAddressBookByReferenceRq::setReference()
     * @uses SearchAddressBookByReferenceRq::setShipper_num()
     * @uses SearchAddressBookByReferenceRq::setUser_id()
     * @param int $page_num
     ...
     */
    public function __construct($page_num = null, $password = null, $reference = null, array $shipper_num = array(), $user_id = null)
    {
        $this
     ...
     * Set page_num value
     * @param int $page_num
     * @return \Canpar\Ship\StructType\SearchAddressBookByReferenceRq
     */
    ...
    public static function validateShipper_numForArrayConstraintsFromSetShipper_num(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $searchAddressBookByReferenceRqShipper_numItem) {
            // validation for constraint: itemType
            if (!is_string($searchAddressBookByReferenceRqShipper_numItem)) {
                $invalidValues[] = is_object($searchAddressBookByReferenceRqShipper_numItem) ? get_class($searchAddressBookByReferenceRqShipper_numItem) : sprintf('%s(%s)', gettype($searchAddressBookByReferenceRqShipper_numItem), var_export($searchAddressBookByReferenceRqShipper_numItem, true));
            }
        }
