...
/**
 * This class stands for DeleteCommodityRq StructType
 * @subpackage Structs
 */
class DeleteCommodityRq extends AbstractStructBase
{
    /**
     * The id
    ...
    public $user_id;
    /**
     * Constructor method for DeleteCommodityRq
     * @uses DeleteCommodityRq::setId()
     * @uses DeleteCommodityRq::setPassword()
     * @uses DeleteCommodityRq::setUser_id()
     * @param int $id
     ...
     * Set id value
     * @param int $id
     * @return \Canpar\Ship\StructType\DeleteCommodityRq
     */
