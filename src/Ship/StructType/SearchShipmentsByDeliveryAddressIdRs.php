...
/**
 * This class stands for SearchShipmentsByDeliveryAddressIdRs StructType
 * @subpackage Structs
 */
class SearchShipmentsByDeliveryAddressIdRs extends AbstractStructBase
{
    /**
     * The error
    ...
    public $shipment;
    /**
     * Constructor method for SearchShipmentsByDeliveryAddressIdRs
     * @uses SearchShipmentsByDeliveryAddressIdRs::setError()
     * @uses SearchShipmentsByDeliveryAddressIdRs::setShipment()
     * @param string $error
     ...
     * @param string $error
     * @return \Canpar\Ship\StructType\SearchShipmentsByDeliveryAddressIdRs
     */
    ...
    public static function validateShipmentForArrayConstraintsFromSetShipment(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $searchShipmentsByDeliveryAddressIdRsShipmentItem) {
            // validation for constraint: itemType
            if (!$searchShipmentsByDeliveryAddressIdRsShipmentItem instanceof \Canpar\Ship\StructType\Shipment) {
                $invalidValues[] = is_object($searchShipmentsByDeliveryAddressIdRsShipmentItem) ? get_class($searchShipmentsByDeliveryAddressIdRsShipmentItem) : sprintf('%s(%s)', gettype($searchShipmentsByDeliveryAddressIdRsShipmentItem), var_export($searchShipmentsByDeliveryAddressIdRsShipmentItem, true));
            }
        }
