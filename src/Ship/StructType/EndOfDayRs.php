...
/**
 * This class stands for EndOfDayRs StructType
 * @subpackage Structs
 */
class EndOfDayRs extends AbstractStructBase
{
    /**
     * The error
    ...
    public $manifest_num;
    /**
     * Constructor method for EndOfDayRs
     * @uses EndOfDayRs::setError()
     * @uses EndOfDayRs::setManifest_num()
     * @param string $error
     ...
     * @param string $error
     * @return \Canpar\Ship\StructType\EndOfDayRs
     */
