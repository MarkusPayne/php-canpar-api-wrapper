...
/**
 * This class stands for SearchAddressBookByPostalCodeRs StructType
 * @subpackage Structs
 */
class SearchAddressBookByPostalCodeRs extends AbstractStructBase
{
    /**
     * The address
    ...
    public $error;
    /**
     * Constructor method for SearchAddressBookByPostalCodeRs
     * @uses SearchAddressBookByPostalCodeRs::setAddress()
     * @uses SearchAddressBookByPostalCodeRs::setError()
    ...
    public static function validateAddressForArrayConstraintsFromSetAddress(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $searchAddressBookByPostalCodeRsAddressItem) {
            // validation for constraint: itemType
            if (!$searchAddressBookByPostalCodeRsAddressItem instanceof \Canpar\Ship\StructType\AddressBook) {
                $invalidValues[] = is_object($searchAddressBookByPostalCodeRsAddressItem) ? get_class($searchAddressBookByPostalCodeRsAddressItem) : sprintf('%s(%s)', gettype($searchAddressBookByPostalCodeRsAddressItem), var_export($searchAddressBookByPostalCodeRsAddressItem, true));
            }
        }
     ...
     * @param \Canpar\Ship\StructType\AddressBook[] $address
     * @return \Canpar\Ship\StructType\SearchAddressBookByPostalCodeRs
     */
