...
/**
 * This class stands for SearchShipmentsByAlternativeReferenceRs StructType
 * @subpackage Structs
 */
class SearchShipmentsByAlternativeReferenceRs extends AbstractStructBase
{
    /**
     * The error
    ...
    public $shipment;
    /**
     * Constructor method for SearchShipmentsByAlternativeReferenceRs
     * @uses SearchShipmentsByAlternativeReferenceRs::setError()
     * @uses SearchShipmentsByAlternativeReferenceRs::setShipment()
     * @param string $error
     ...
     * @param string $error
     * @return \Canpar\Ship\StructType\SearchShipmentsByAlternativeReferenceRs
     */
    ...
    public static function validateShipmentForArrayConstraintsFromSetShipment(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $searchShipmentsByAlternativeReferenceRsShipmentItem) {
            // validation for constraint: itemType
            if (!$searchShipmentsByAlternativeReferenceRsShipmentItem instanceof \Canpar\Ship\StructType\Shipment) {
                $invalidValues[] = is_object($searchShipmentsByAlternativeReferenceRsShipmentItem) ? get_class($searchShipmentsByAlternativeReferenceRsShipmentItem) : sprintf('%s(%s)', gettype($searchShipmentsByAlternativeReferenceRsShipmentItem), var_export($searchShipmentsByAlternativeReferenceRsShipmentItem, true));
            }
        }
