...
/**
 * This class stands for ExportAddressBookRs StructType
 * @subpackage Structs
 */
class ExportAddressBookRs extends AbstractStructBase
{
    /**
     * The error
    ...
    public $file;
    /**
     * Constructor method for ExportAddressBookRs
     * @uses ExportAddressBookRs::setError()
     * @uses ExportAddressBookRs::setFile()
     * @param string $error
     * @param string $file
     */
     ...
     * @param string $error
     * @return \Canpar\Ship\StructType\ExportAddressBookRs
     */
