...
/**
 * This class stands for SearchShipmentsByOrderIdRs StructType
 * @subpackage Structs
 */
class SearchShipmentsByOrderIdRs extends AbstractStructBase
{
    /**
     * The error
    ...
    public $shipment;
    /**
     * Constructor method for SearchShipmentsByOrderIdRs
     * @uses SearchShipmentsByOrderIdRs::setError()
     * @uses SearchShipmentsByOrderIdRs::setShipment()
     * @param string $error
     ...
     * @param string $error
     * @return \Canpar\Ship\StructType\SearchShipmentsByOrderIdRs
     */
    ...
    public static function validateShipmentForArrayConstraintsFromSetShipment(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $searchShipmentsByOrderIdRsShipmentItem) {
            // validation for constraint: itemType
            if (!$searchShipmentsByOrderIdRsShipmentItem instanceof \Canpar\Ship\StructType\Shipment) {
                $invalidValues[] = is_object($searchShipmentsByOrderIdRsShipmentItem) ? get_class($searchShipmentsByOrderIdRsShipmentItem) : sprintf('%s(%s)', gettype($searchShipmentsByOrderIdRsShipmentItem), var_export($searchShipmentsByOrderIdRsShipmentItem, true));
            }
        }
