...
/**
 * This class stands for GetShipmentsAfterDayRq StructType
 * @subpackage Structs
 */
class GetShipmentsAfterDayRq extends AbstractStructBase
{
    /**
     * The after
    ...
    public $user_id;
    /**
     * Constructor method for GetShipmentsAfterDayRq
     * @uses GetShipmentsAfterDayRq::setAfter()
     * @uses GetShipmentsAfterDayRq::setPassword()
     * @uses GetShipmentsAfterDayRq::setShipper_num()
     * @uses GetShipmentsAfterDayRq::setUser_id()
     * @param string $after
     * @param string $password
     * @param string $shipper_num
     * @param string $user_id
     */
    public function __construct($after = null, $password = null, $shipper_num = null, $user_id = null)
    {
        $this
            ->setAfter($after)
    ...
    {
        return isset($this->after) ? $this->after : null;
    }
    /**
     * Set after value
     ...
     * @param string $after
     * @return \Canpar\Ship\StructType\GetShipmentsAfterDayRq
     */
    public function setAfter($after = null)
    {
        // validation for constraint: string
        if (!is_null($after) && !is_string($after)) {
            throw new \InvalidArgumentException(sprintf('Invalid value %s, please provide a string, %s given', var_export($after, true), gettype($after)), __LINE__);
        }
        if (is_null($after) || (is_array($after) && empty($after))) {
            unset($this->after);
        } else {
            $this->after = $after;
        }
