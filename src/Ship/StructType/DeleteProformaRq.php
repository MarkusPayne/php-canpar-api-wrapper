...
/**
 * This class stands for DeleteProformaRq StructType
 * @subpackage Structs
 */
class DeleteProformaRq extends AbstractStructBase
{
    /**
     * The id
    ...
    public $user_id;
    /**
     * Constructor method for DeleteProformaRq
     * @uses DeleteProformaRq::setId()
     * @uses DeleteProformaRq::setPassword()
     * @uses DeleteProformaRq::setUser_id()
     * @param int $id
     ...
     * Set id value
     * @param int $id
     * @return \Canpar\Ship\StructType\DeleteProformaRq
     */
