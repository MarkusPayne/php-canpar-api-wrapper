...
/**
 * This class stands for GetShipmentsBeforeDayRs StructType
 * @subpackage Structs
 */
class GetShipmentsBeforeDayRs extends AbstractStructBase
{
    /**
     * The error
    ...
    public $shipment;
    /**
     * Constructor method for GetShipmentsBeforeDayRs
     * @uses GetShipmentsBeforeDayRs::setError()
     * @uses GetShipmentsBeforeDayRs::setShipment()
     * @param string $error
     ...
     * @param string $error
     * @return \Canpar\Ship\StructType\GetShipmentsBeforeDayRs
     */
    ...
    public static function validateShipmentForArrayConstraintsFromSetShipment(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $getShipmentsBeforeDayRsShipmentItem) {
            // validation for constraint: itemType
            if (!$getShipmentsBeforeDayRsShipmentItem instanceof \Canpar\Ship\StructType\Shipment) {
                $invalidValues[] = is_object($getShipmentsBeforeDayRsShipmentItem) ? get_class($getShipmentsBeforeDayRsShipmentItem) : sprintf('%s(%s)', gettype($getShipmentsBeforeDayRsShipmentItem), var_export($getShipmentsBeforeDayRsShipmentItem, true));
            }
        }
