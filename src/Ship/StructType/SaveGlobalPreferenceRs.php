...
/**
 * This class stands for SaveGlobalPreferenceRs StructType
 * @subpackage Structs
 */
class SaveGlobalPreferenceRs extends AbstractStructBase
{
    /**
     * The error
    ...
    /**
     * Constructor method for SaveGlobalPreferenceRs
     * @uses SaveGlobalPreferenceRs::setError()
     * @uses SaveGlobalPreferenceRs::setGlobal_preference()
     * @param string $error
     ...
     * @param string $error
     * @return \Canpar\Ship\StructType\SaveGlobalPreferenceRs
     */
