...
/**
 * This class stands for SearchAddressBookByAddressIdRs StructType
 * @subpackage Structs
 */
class SearchAddressBookByAddressIdRs extends AbstractStructBase
{
    /**
     * The address
    ...
    public $error;
    /**
     * Constructor method for SearchAddressBookByAddressIdRs
     * @uses SearchAddressBookByAddressIdRs::setAddress()
     * @uses SearchAddressBookByAddressIdRs::setError()
    ...
    public static function validateAddressForArrayConstraintsFromSetAddress(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $searchAddressBookByAddressIdRsAddressItem) {
            // validation for constraint: itemType
            if (!$searchAddressBookByAddressIdRsAddressItem instanceof \Canpar\Ship\StructType\AddressBook) {
                $invalidValues[] = is_object($searchAddressBookByAddressIdRsAddressItem) ? get_class($searchAddressBookByAddressIdRsAddressItem) : sprintf('%s(%s)', gettype($searchAddressBookByAddressIdRsAddressItem), var_export($searchAddressBookByAddressIdRsAddressItem, true));
            }
        }
     ...
     * @param \Canpar\Ship\StructType\AddressBook[] $address
     * @return \Canpar\Ship\StructType\SearchAddressBookByAddressIdRs
     */
