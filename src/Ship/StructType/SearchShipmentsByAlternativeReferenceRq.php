...
/**
 * This class stands for SearchShipmentsByAlternativeReferenceRq StructType
 * @subpackage Structs
 */
class SearchShipmentsByAlternativeReferenceRq extends AbstractStructBase
{
    /**
    ...
    public $user_id;
    /**
     * Constructor method for SearchShipmentsByAlternativeReferenceRq
     * @uses SearchShipmentsByAlternativeReferenceRq::setAlternative_reference()
     * @uses SearchShipmentsByAlternativeReferenceRq::setFrom_shipping_date()
     * @uses SearchShipmentsByAlternativeReferenceRq::setPage_num()
     * @uses SearchShipmentsByAlternativeReferenceRq::setPassword()
     * @uses SearchShipmentsByAlternativeReferenceRq::setShipper_num()
     * @uses SearchShipmentsByAlternativeReferenceRq::setTo_shipping_date()
     * @uses SearchShipmentsByAlternativeReferenceRq::setUser_id()
     ...
     */
    public function __construct($alternative_reference = null, $from_shipping_date = null, $page_num = null, $password = null, $shipper_num = null, $to_shipping_date = null, $user_id = null)
    {
        $this
     ...
     * @param string $alternative_reference
     * @return \Canpar\Ship\StructType\SearchShipmentsByAlternativeReferenceRq
     */
