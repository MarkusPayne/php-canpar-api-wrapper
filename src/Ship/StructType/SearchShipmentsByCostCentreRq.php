...
/**
 * This class stands for SearchShipmentsByCostCentreRq StructType
 * @subpackage Structs
 */
class SearchShipmentsByCostCentreRq extends AbstractStructBase
{
    /**
     * The division
    ...
    public $user_id;
    /**
     * Constructor method for SearchShipmentsByCostCentreRq
     * @uses SearchShipmentsByCostCentreRq::setDivision()
     * @uses SearchShipmentsByCostCentreRq::setFrom_shipping_date()
     * @uses SearchShipmentsByCostCentreRq::setPage_num()
     * @uses SearchShipmentsByCostCentreRq::setPassword()
     * @uses SearchShipmentsByCostCentreRq::setShipper_num()
     * @uses SearchShipmentsByCostCentreRq::setTo_shipping_date()
     * @uses SearchShipmentsByCostCentreRq::setUser_id()
     ...
     */
    public function __construct($division = null, $from_shipping_date = null, $page_num = null, $password = null, $shipper_num = null, $to_shipping_date = null, $user_id = null)
    {
        $this
     ...
     * @param string $division
     * @return \Canpar\Ship\StructType\SearchShipmentsByCostCentreRq
     */
