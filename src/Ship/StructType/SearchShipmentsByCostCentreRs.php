...
/**
 * This class stands for SearchShipmentsByCostCentreRs StructType
 * @subpackage Structs
 */
class SearchShipmentsByCostCentreRs extends AbstractStructBase
{
    /**
     * The error
    ...
    public $shipment;
    /**
     * Constructor method for SearchShipmentsByCostCentreRs
     * @uses SearchShipmentsByCostCentreRs::setError()
     * @uses SearchShipmentsByCostCentreRs::setShipment()
     * @param string $error
     ...
     * @param string $error
     * @return \Canpar\Ship\StructType\SearchShipmentsByCostCentreRs
     */
    ...
    public static function validateShipmentForArrayConstraintsFromSetShipment(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $searchShipmentsByCostCentreRsShipmentItem) {
            // validation for constraint: itemType
            if (!$searchShipmentsByCostCentreRsShipmentItem instanceof \Canpar\Ship\StructType\Shipment) {
                $invalidValues[] = is_object($searchShipmentsByCostCentreRsShipmentItem) ? get_class($searchShipmentsByCostCentreRsShipmentItem) : sprintf('%s(%s)', gettype($searchShipmentsByCostCentreRsShipmentItem), var_export($searchShipmentsByCostCentreRsShipmentItem, true));
            }
        }
