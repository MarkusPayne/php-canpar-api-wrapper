...
/**
 * This class stands for SearchShipmentsByOrderIdRq StructType
 * @subpackage Structs
 */
class SearchShipmentsByOrderIdRq extends AbstractStructBase
{
    /**
    ...
    public $user_id;
    /**
     * Constructor method for SearchShipmentsByOrderIdRq
     * @uses SearchShipmentsByOrderIdRq::setFrom_shipping_date()
     * @uses SearchShipmentsByOrderIdRq::setOrder_id()
     * @uses SearchShipmentsByOrderIdRq::setPage_num()
     * @uses SearchShipmentsByOrderIdRq::setPassword()
     * @uses SearchShipmentsByOrderIdRq::setShipper_num()
     * @uses SearchShipmentsByOrderIdRq::setTo_shipping_date()
     * @uses SearchShipmentsByOrderIdRq::setUser_id()
     ...
     */
    public function __construct($from_shipping_date = null, $order_id = null, $page_num = null, $password = null, $shipper_num = null, $to_shipping_date = null, $user_id = null)
    {
        $this
     ...
     * @param string $from_shipping_date
     * @return \Canpar\Ship\StructType\SearchShipmentsByOrderIdRq
     */
