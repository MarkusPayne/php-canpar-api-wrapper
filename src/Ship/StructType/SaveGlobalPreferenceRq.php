...
/**
 * This class stands for SaveGlobalPreferenceRq StructType
 * @subpackage Structs
 */
class SaveGlobalPreferenceRq extends AbstractStructBase
{
    /**
    ...
    public $user_id;
    /**
     * Constructor method for SaveGlobalPreferenceRq
     * @uses SaveGlobalPreferenceRq::setGlobal_preference()
     * @uses SaveGlobalPreferenceRq::setPassword()
     * @uses SaveGlobalPreferenceRq::setUser_id()
     ...
     * @param \Canpar\Ship\StructType\GlobalPreference $global_preference
     * @return \Canpar\Ship\StructType\SaveGlobalPreferenceRq
     */
