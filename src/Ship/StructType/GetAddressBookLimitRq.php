...
/**
 * This class stands for GetAddressBookLimitRq StructType
 * @subpackage Structs
 */
class GetAddressBookLimitRq extends AbstractStructBase
{
    /**
     * The password
    ...
    public $user_id;
    /**
     * Constructor method for GetAddressBookLimitRq
     * @uses GetAddressBookLimitRq::setPassword()
     * @uses GetAddressBookLimitRq::setShipper_num()
     * @uses GetAddressBookLimitRq::setUser_id()
     ...
     * @param string $password
     * @return \Canpar\Ship\StructType\GetAddressBookLimitRq
     */
