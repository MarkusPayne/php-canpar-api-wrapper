...
/**
 * This class stands for SearchShipmentsByDeliveryCityRs StructType
 * @subpackage Structs
 */
class SearchShipmentsByDeliveryCityRs extends AbstractStructBase
{
    /**
     * The error
    ...
    public $shipment;
    /**
     * Constructor method for SearchShipmentsByDeliveryCityRs
     * @uses SearchShipmentsByDeliveryCityRs::setError()
     * @uses SearchShipmentsByDeliveryCityRs::setShipment()
     * @param string $error
     ...
     * @param string $error
     * @return \Canpar\Ship\StructType\SearchShipmentsByDeliveryCityRs
     */
    ...
    public static function validateShipmentForArrayConstraintsFromSetShipment(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $searchShipmentsByDeliveryCityRsShipmentItem) {
            // validation for constraint: itemType
            if (!$searchShipmentsByDeliveryCityRsShipmentItem instanceof \Canpar\Ship\StructType\Shipment) {
                $invalidValues[] = is_object($searchShipmentsByDeliveryCityRsShipmentItem) ? get_class($searchShipmentsByDeliveryCityRsShipmentItem) : sprintf('%s(%s)', gettype($searchShipmentsByDeliveryCityRsShipmentItem), var_export($searchShipmentsByDeliveryCityRsShipmentItem, true));
            }
        }
