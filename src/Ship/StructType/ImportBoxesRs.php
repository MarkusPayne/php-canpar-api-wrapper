...
/**
 * This class stands for ImportBoxesRs StructType
 * @subpackage Structs
 */
class ImportBoxesRs extends AbstractStructBase
{
    /**
     * The error
    ...
    public $result;
    /**
     * Constructor method for ImportBoxesRs
     * @uses ImportBoxesRs::setError()
     * @uses ImportBoxesRs::setResult()
     * @param string $error
     * @param int $result
     */
     ...
     * @param string $error
     * @return \Canpar\Ship\StructType\ImportBoxesRs
     */
