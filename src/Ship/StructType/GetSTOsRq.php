...
/**
 * This class stands for GetSTOsRq StructType
 * @subpackage Structs
 */
class GetSTOsRq extends AbstractStructBase
{
    /**
     * The password
    ...
    public $user_id;
    /**
     * Constructor method for GetSTOsRq
     * @uses GetSTOsRq::setPassword()
     * @uses GetSTOsRq::setShipper_num()
     * @uses GetSTOsRq::setUser_id()
     ...
     * @param string $password
     * @return \Canpar\Ship\StructType\GetSTOsRq
     */
    ...
    public static function validateShipper_numForArrayConstraintsFromSetShipper_num(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $getSTOsRqShipper_numItem) {
            // validation for constraint: itemType
            if (!is_string($getSTOsRqShipper_numItem)) {
                $invalidValues[] = is_object($getSTOsRqShipper_numItem) ? get_class($getSTOsRqShipper_numItem) : sprintf('%s(%s)', gettype($getSTOsRqShipper_numItem), var_export($getSTOsRqShipper_numItem, true));
            }
        }
