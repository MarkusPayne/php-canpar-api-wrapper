...
/**
 * This class stands for AutoratingRs StructType
 * @subpackage Structs
 */
class AutoratingRs extends AbstractStructBase
{
    /**
     * The error
    ...
    public $manifest_num;
    /**
     * Constructor method for AutoratingRs
     * @uses AutoratingRs::setError()
     * @uses AutoratingRs::setManifest_num()
     * @param string $error
     ...
     * @param string $error
     * @return \Canpar\Ship\StructType\AutoratingRs
     */
