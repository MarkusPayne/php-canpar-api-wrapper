...
/**
 * This class stands for SearchShipmentsByDeliveryProvinceRq StructType
 * @subpackage Structs
 */
class SearchShipmentsByDeliveryProvinceRq extends AbstractStructBase
{
    /**
    ...
    public $user_id;
    /**
     * Constructor method for SearchShipmentsByDeliveryProvinceRq
     * @uses SearchShipmentsByDeliveryProvinceRq::setFrom_shipping_date()
     * @uses SearchShipmentsByDeliveryProvinceRq::setPage_num()
     * @uses SearchShipmentsByDeliveryProvinceRq::setPassword()
     * @uses SearchShipmentsByDeliveryProvinceRq::setProvince()
     * @uses SearchShipmentsByDeliveryProvinceRq::setShipper_num()
     * @uses SearchShipmentsByDeliveryProvinceRq::setTo_shipping_date()
     * @uses SearchShipmentsByDeliveryProvinceRq::setUser_id()
     ...
     */
    public function __construct($from_shipping_date = null, $page_num = null, $password = null, $province = null, $shipper_num = null, $to_shipping_date = null, $user_id = null)
    {
        $this
     ...
     * @param string $from_shipping_date
     * @return \Canpar\Ship\StructType\SearchShipmentsByDeliveryProvinceRq
     */
