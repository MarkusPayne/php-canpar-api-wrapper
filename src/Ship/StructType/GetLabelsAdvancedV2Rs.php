...
/**
 * This class stands for GetLabelsAdvancedV2Rs StructType
 * @subpackage Structs
 */
class GetLabelsAdvancedV2Rs extends AbstractStructBase
{
    /**
     * The error
    ...
    public $labels;
    /**
     * Constructor method for GetLabelsAdvancedV2Rs
     * @uses GetLabelsAdvancedV2Rs::setError()
     * @uses GetLabelsAdvancedV2Rs::setLabels()
     * @param string $error
     * @param string[] $labels
     */
     ...
     * @param string $error
     * @return \Canpar\Ship\StructType\GetLabelsAdvancedV2Rs
     */
