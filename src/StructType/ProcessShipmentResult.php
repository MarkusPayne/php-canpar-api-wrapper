...
class ProcessShipmentResult extends AbstractStructBase
{
     ...
     */
    public function __construct(array $errors = array(), array $messages = array(), \Canpar\StructType\Shipment $shipment = null)
    {
        $this
            ->setErrors($errors)
     ...
     * @param string[] $errors
     * @return \Canpar\StructType\ProcessShipmentResult
     */
