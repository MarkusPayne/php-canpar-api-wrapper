...
class RateShipmentAllPremiumsRq extends AbstractStructBase
{
     ...
     */
    public function __construct($apply_association_discount = null, $apply_individual_discount = null, $apply_invoice_discount = null, $password = null, \Canpar\StructType\Shipment $shipment = null, $type = null, $user_id = null)
    {
        $this
     ...
     * @param bool $apply_association_discount
     * @return \Canpar\StructType\RateShipmentAllPremiumsRq
     */
