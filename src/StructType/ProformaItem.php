...
class ProformaItem extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Canpar\StructType\CommodityInfo
     */
     ...
     * @param \Canpar\StructType\CommodityInfo $commodity_info
     * @param int $id
     * @param string $inserted_on
     * @param int $quantity
     * @param string $updated_on
     */
    public function __construct(\Canpar\StructType\CommodityInfo $commodity_info = null, $id = null, $inserted_on = null, $quantity = null, $updated_on = null)
    {
        $this
     ...
     * @return \Canpar\StructType\CommodityInfo|null
     */
     ...
     * @param \Canpar\StructType\CommodityInfo $commodity_info
     * @return \Canpar\StructType\ProformaItem
     */
    public function setCommodity_info(\Canpar\StructType\CommodityInfo $commodity_info = null)
    {
