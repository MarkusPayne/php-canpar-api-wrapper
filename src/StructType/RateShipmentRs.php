...
/**
 * This class stands for RateShipmentRs StructType
 * @subpackage Structs
 */
class RateShipmentRs extends AbstractStructBase
{
    /**
     * The error
    ...
    /**
     * Constructor method for RateShipmentRs
     * @uses RateShipmentRs::setError()
     * @uses RateShipmentRs::setProcessShipmentResult()
     * @param string $error
     * @param \Canpar\StructType\ProcessShipmentResult $processShipmentResult
     */
    public function __construct($error = null, \Canpar\StructType\ProcessShipmentResult $processShipmentResult = null)
    {
        $this
            ->setError($error)
     ...
     * @param string $error
     * @return \Canpar\StructType\RateShipmentRs
     */
     ...
     * @return \Canpar\StructType\RateShipmentRs
     */
    public function setProcessShipmentResult(\Canpar\StructType\ProcessShipmentResult $processShipmentResult = null)
    {
