...
class Package extends AbstractStructBase
{
     ...
     * @param \Canpar\StructType\COD $cod
     ...
     * @param string $alternative_reference
     * @return \Canpar\StructType\Package
     */
     ...
     * this property may have been unset before, due to the fact that this property is
     * removable from the request (nillable=true+minOccurs=0)
     * @return \Canpar\StructType\COD|null
     */
     ...
     * @return \Canpar\StructType\Package
     */
    public function setCod(\Canpar\StructType\COD $cod = null)
    {
